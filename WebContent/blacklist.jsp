	...
	<script>
		...
		for(var i=(num-1)*10;i<(num*10);i++) {
			...
			str += "<form action='black' method='post'>";
							...
							str += "<div class='td' style='width:400px'>" + json[i].addr + "</div>";

							str += "<div class='td' style='width:100px'>" + json[i].blacklist + "</div>";

							str += "<div class='td' style='width:100px'>" + json[i].type + "</div>";

							str += "<div class='td' style='width:100px'><input type='submit's value='해제' formaction='white' /></div>";
